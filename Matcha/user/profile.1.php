...
<html>
    ...
    <body>
        <div class="topnav">
            ...
            <a href="../server/notifications.php"><img class="img" src="https://www.materialui.co/materialIcons/social/notifications_white_192x192.png" alt="NOTOFICATIONS"></a>
        ...
        <form  id="navbuttons" action=""  method="post">
            <div class="centered">
                <div class="sidebar">
                    <img class="profpic" src="../images/profile.png">
                ...
                <div class="infobar">
                    <div id="basicinfo" class="page">
                        <form action="" method="post">
                            ...
                            <p>LOCATION</p>
                            <p><?php if ($row['user_location'] != null) {echo $row['user_location'];} else {echo "No gender specified";}?></p>
                            <button class="location" name="accesslocation">Allow Access</button>
                            <?php
                                }
                            ?>
                            <br><br><br>
                    ...
                    <div id="intrsts" class="page" style="display:none;">
                        ...
                        <input type="text" name="interests"><button name="add_interest">SUBMIT</button>
                        <br><br>
                        ...
                        ?>
                        <button type="button" value="<?php echo "#".$interests;?>" class="interestbtn"><?php echo "#".$interests;?></button><?php } ?>
                    </div>
                    ...
                    <div id="bio" class="page">
                        ...
                        <textarea name="biography" maxlength="200"><?php echo $biography;?></textarea>
                        <button class="biobtn" name="biobtn">SUBMIT</button>
                    </div>

                    <div id="gal" class="page">
                        <h2>GALLERY</h2>

                        <label>
                            <img class="upload_pp" src="http://icons.iconarchive.com/icons/paomedia/small-n-flat/1024/device-camera-icon.png" alt="upload">
                            <input class="propic" type="file" accept="image/*" id="uploadimg" name="uploadimg"><input type="checkbox" value="usedp" name="usedp" id="usedp">use as pro pic
                        </label>
